...
import preprocessor, data_visualizer, ML_models, postprocessor
import joblib
...
def load():
    ...
    df.rename(columns={'Ap_hi': 'BP_hi', 'Ap_lo': 'BP_lo',
...
if __name__ == "__main__":
    ...
    svc_model, svc_pred, svc_report = ML_models.svc_model(X_train_scaled, X_test_scaled, y_train, y_test)
    kNN_model, kNN_pred, kNN_report = ML_models.kNN_model(X_train, X_test, y_train, y_test)
    RF_model, RF_pred, RF_report = ML_models.RF_model(X_train_scaled, X_test_scaled, y_train, y_test)
